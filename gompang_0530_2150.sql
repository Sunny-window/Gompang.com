...
CREATE TABLE IF NOT EXISTS `basket` (
  ...
  CONSTRAINT `FK_basket_members` FOREIGN KEY (`username`) REFERENCES `members` (`username`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- 테이블 데이터 gompangrep.basket:~6 rows (대략적) 내보내기
DELETE FROM `basket`;
...
-- 테이블 gompangrep.filetest 구조 내보내기
CREATE TABLE IF NOT EXISTS `filetest` (
  `url` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- 테이블 데이터 gompangrep.filetest:~7 rows (대략적) 내보내기
...
-- 테이블 gompangrep.members 구조 내보내기
CREATE TABLE IF NOT EXISTS `members` (
  `username` varchar(255) NOT NULL,
  `pwd` varchar(255) NOT NULL,
  `role` varchar(255) NOT NULL DEFAULT 'user' COMMENT 'user or manager',
  PRIMARY KEY (`username`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 테이블 데이터 gompangrep.members:~3 rows (대략적) 내보내기
DELETE FROM `members`;
INSERT INTO `members` (`username`, `pwd`, `role`) VALUES
	('1', '1', 'ROLE_MEMBER'),
	('13', '13', 'ROLE_MEMBER'),
	('root', '1', 'ROLE_ADMIN');

-- 테이블 gompangrep.offer 구조 내보내기
CREATE TABLE IF NOT EXISTS `offer` (
  ...
  CONSTRAINT `FK_offer_members` FOREIGN KEY (`username`) REFERENCES `members` (`username`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- 테이블 데이터 gompangrep.offer:~5 rows (대략적) 내보내기
DELETE FROM `offer`;
INSERT INTO `offer` (`ocode`, `username`, `pcode`, `amount`, `odate`) VALUES
	...
	(19, 'root', 24, 1, '2024-05-30');

-- 테이블 gompangrep.product 구조 내보내기
...
-- 테이블 데이터 gompangrep.product:~19 rows (대략적) 내보내기
DELETE FROM `product`;
...
CREATE TABLE IF NOT EXISTS `review` (
  ...
  KEY `pcode` (`pcode`),
  CONSTRAINT `FK_review_members` FOREIGN KEY (`username`) REFERENCES `members` (`username`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_review_product` FOREIGN KEY (`pcode`) REFERENCES `product` (`pcode`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- 테이블 데이터 gompangrep.review:~0 rows (대략적) 내보내기
DELETE FROM `review`;
